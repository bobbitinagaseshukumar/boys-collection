export const products = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    description:
      "Crafted from the finest Egyptian cotton with a subtle texture weave, this Oxford shirt delivers unparalleled comfort and a tailored silhouette. Mother-of-pearl buttons and reinforced collar stays complete the refined look.",
    price: 4999,
    originalPrice: 7999,
    discount: 38,
    rating: 4.8,
  ...
  },
  {
    ...
    description:
      "Woven from pure Italian linen in Tuscany, this shirt embodies Mediterranean elegance. The relaxed drape and natural breathability make it perfect for warm-weather sophistication.",
    price: 5999,
    originalPrice: 8999,
    discount: 33,
    rating: 4.7,
  ...
  },
  {
    ...
    description:
      "A masterfully tailored dress shirt blending premium silk and cotton for a lustrous finish. French cuffs and a spread collar elevate any formal ensemble to black-tie perfection.",
    price: 7999,
    originalPrice: 12999,
    discount: 38,
    rating: 4.9,
  ...
  },
  {
    ...
    description:
      "A contemporary take on the classic band collar, this shirt features premium Supima cotton with a subtle jacquard pattern. Perfect for the modern gentleman who values understated elegance.",
    price: 3999,
    originalPrice: 5999,
    discount: 33,
    rating: 4.6,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    description:
      "Hand-finished wool trousers with a precision-cut slim taper. The premium Italian wool blend drapes beautifully and holds its crease all day. Features a hidden flex waistband for effortless comfort.",
    price: 6999,
    originalPrice: 9999,
    discount: 30,
    rating: 4.8,
  ...
  },
  {
    ...
    description:
      "Engineered with a 4-way stretch cotton-elastane blend for all-day mobility. The garment-dyed finish gives each pair a unique, lived-in character while maintaining a polished silhouette.",
    price: 3499,
    originalPrice: 5499,
    discount: 36,
    rating: 4.5,
  ...
  },
  {
    ...
    description:
      "Relaxed-fit linen trousers with an adjustable drawstring waist and tapered ankle. Crafted from breathable European flax linen that softens beautifully with every wash.",
    price: 4499,
    originalPrice: 6999,
    discount: 36,
    rating: 4.6,
  ...
  },
  {
    ...
    description:
      "Classic double-pleated dress pants in a luxurious tropical wool blend. The high-rise cut and full break create a distinguished, timeless aesthetic favored by discerning gentlemen.",
    price: 5999,
    originalPrice: 8499,
    discount: 29,
    rating: 4.7,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    description:
      "Crafted from premium Japanese selvedge denim on vintage shuttle looms, these raw jeans develop a unique patina over time. The 14oz heavyweight fabric is built for decades, not seasons.",
    price: 6499,
    originalPrice: 9999,
    discount: 35,
    rating: 4.9,
  ...
  },
  {
    ...
    description:
      "Modern slim-fit jeans engineered with advanced stretch technology for unmatched comfort. The hand-sanded whisker wash and subtle distressing deliver effortless downtown style.",
    price: 3999,
    originalPrice: 5999,
    discount: 33,
    rating: 4.6,
  ...
  },
  {
    ...
    description:
      "A relaxed thigh that tapers to a clean ankle — the ideal balance of comfort and contemporary style. Premium Turkish cotton denim with a structured twill weave for enduring quality.",
    price: 4499,
    originalPrice: 6999,
    discount: 36,
    rating: 4.5,
  ...
  },
  {
    ...
    description:
      "Each pair is individually hand-distressed by artisans for a one-of-a-kind finish. The premium Italian stretch denim moves with you while the ripped detailing adds bold, editorial edge.",
    price: 5499,
    originalPrice: 8999,
    discount: 39,
    rating: 4.7,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    description:
      "The quintessential luxury t-shirt in ultra-soft Peruvian Pima cotton. A heavier 200 GSM weight provides structure and opacity while the pre-shrunk finish ensures a consistent fit wash after wash.",
    price: 2499,
    originalPrice: 3999,
    discount: 38,
    rating: 4.7,
  ...
  },
  {
    ...
    description:
      "Limited-edition graphic tee featuring original artwork by emerging Indian artists. Printed using eco-friendly water-based inks on organic cotton for a soft hand-feel that lasts.",
    price: 1999,
    originalPrice: 2999,
    discount: 33,
    rating: 4.4,
    ...
    isNewArrival: true,
    stock: 85,
    tags: ["graphic", "art", "limited-edition"],
  },
  {
    id: 15,
    ...
    description:
      "A refined henley with a three-button placket and raglan sleeves, cut from a luxurious modal-cotton blend. The garment-dyed finish creates rich, dimensional color with a worn-in softness.",
    price: 2999,
    originalPrice: 4499,
    discount: 33,
    rating: 4.6,
  ...
  },
  {
    ...
    description:
      "Intentionally oversized with dropped shoulders and an extended body for a contemporary streetwear aesthetic. The heavyweight 280 GSM cotton delivers a premium, structured drape.",
    price: 2299,
    originalPrice: 3499,
    discount: 34,
    rating: 4.5,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    description:
      "A luxury zip-up hoodie in heavyweight French terry with a brushed interior. Swiss-made YKK zippers, ribbed cuffs, and a lined hood with an adjustable drawcord make this a cut above the rest.",
    price: 5499,
    originalPrice: 7999,
    discount: 31,
    rating: 4.8,
    ...
    isNewArrival: false,
    stock: 37,
    tags: ["zip-up", "french-terry", "premium"],
  },
  {
    id: 18,
    ...
    description:
      "Wrapped in plush Italian fleece, this pullover hoodie is the ultimate in cozy luxury. The oversized kangaroo pocket and double-layered hood provide warmth and effortless street style.",
    price: 4999,
    originalPrice: 6999,
    discount: 29,
    rating: 4.7,
  ...
  },
  {
    ...
    description:
      "Engineered with a dual-layer spacer fabric that traps warmth without bulk. Bonded seams, laser-cut ventilation panels, and zip pockets deliver a futuristic, performance-driven silhouette.",
    price: 6999,
    originalPrice: 9999,
    discount: 30,
    rating: 4.9,
  ...
  },
  {
    ...
    description:
      "The pinnacle of hoodie luxury — crafted from a cashmere-merino wool blend sourced from the highlands of Mongolia. Impossibly soft, naturally temperature-regulating, and built to age gracefully.",
    price: 9999,
    originalPrice: 12999,
    discount: 23,
    rating: 4.9,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    description:
      "Handcrafted from buttery-soft Italian lambskin leather with asymmetric zip closure and antique brass hardware. Fully lined in quilted satin with interior pockets. A timeless rebellion staple.",
    price: 12999,
    originalPrice: 18999,
    discount: 32,
    rating: 4.9,
  ...
  },
  {
    ...
    description:
      "A modern bomber silhouette elevated with diamond quilting and a premium satin shell. The ribbed collar, cuffs, and hem provide a snug fit while the lightweight insulation keeps you warm without bulk.",
    price: 7499,
    originalPrice: 10999,
    discount: 32,
    rating: 4.7,
  ...
  },
  {
    ...
    slug: "wool-overcoat",
    description:
      "A statement overcoat in double-faced Italian wool with a notch lapel and single-breasted construction. The mid-thigh length and clean lines make it the definitive piece for sharp winter layering.",
    price: 11999,
    originalPrice: 16999,
    discount: 29,
    rating: 4.8,
  ...
  },
  {
    ...
    description:
      "A lightweight, water-resistant windbreaker with sealed seams and reflective accents. The packable design folds into its own pocket, making it the perfect travel companion for the jet-setting gentleman.",
    price: 4999,
    originalPrice: 7499,
    discount: 33,
    rating: 4.5,
    ...
    isNewArrival: true,
    stock: 61,
    tags: ["windbreaker", "lightweight", "travel"],
  },
];
